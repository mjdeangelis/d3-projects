// var LineChart2 = (function(window,d3) { 

lineChart("linechart-2-container", "linechart-2", "linechart2-data.csv");
lineChart("linechart-3-container", "linechart-3", "linechart3-data.csv");

function lineChart(containerID, chartID, dataLoc) {

  //Initialize Variables
  var lineContainerWidth, lineMargin, lineWidth, lineHeight;
